  ...
  const iconList = [
    {
      id: 1,
      name: "Python",
      icon: <FaPython size={70} color="black" />,
    },
    {
      id: 2,
      name: "Node",
      icon: <FaNode size={70} color="black" />,
    },
    {
      id: 3,
      name: "Docker",
      icon: <FaDocker size={70} color="black" />,
    },
    {
      id: 4,
      name: "Django",
      icon: <SiDjango size={70} color="black" />,
    },
    {
      id: 5,
      name: "Flask",
      icon: <SiFlask size={70} color="black" />,
    },
    {
      id: 6,
      name: "ReactJs",
